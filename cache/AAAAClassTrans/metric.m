...
{{(216*(-(TBsp[Global`p1, Global`p1]*TBsp[Global`p2, Global`p4]^2*
     ...
     (TBsp[Global`p1, Global`p1]*TBsp[Global`p2, Global`p3]^2 + 
      ...
      TBsp[Global`p1, Global`p3]*(-(TBsp[Global`p2, Global`p4]*
         TBsp[Global`p3, Global`p4]) + 3*TBsp[Global`p2, Global`p3]*
        TBsp[Global`p4, Global`p4])))/(TBsp[Global`p1, Global`p1]*
    TBsp[Global`p2, Global`p2]*TBsp[Global`p3, Global`p3]*
    TBsp[Global`p4, Global`p4])}}
