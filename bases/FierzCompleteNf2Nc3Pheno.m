...
{"\!\(\*SubscriptBox[\(\[ScriptCapitalL]\), SubscriptBox[\((V + A)\), \(\[Perpendicular]\)]]\)","(\!\(\*OverscriptBox[\(q\), \(_\)]\) \!\(\*SubscriptBox[\(\[Gamma]\), \(i\)]\)\!\(\*SuperscriptBox[\(T\), \(0\(\\\ \)\)]\)q\!\(\*SuperscriptBox[\()\), \(2\)]\) + (\!\(\*OverscriptBox[\(q\), \(_\)]\) \!\(\*SubscriptBox[\(i\[Gamma]\), \(i\)]\)\!\(\*SubscriptBox[\(\[Gamma]\), \(5\)]\)\!\(\*SuperscriptBox[\(T\), \(0\(\\\ \)\)]\)q\!\(\*SuperscriptBox[\()\), \(2\)]\)"},
{"\!\(\*SubscriptBox[\(\[ScriptCapitalL]\), SubscriptBox[\((V - A)\), \(\[LeftDoubleBracketingBar]\)]]\)","(\!\(\*OverscriptBox[\(q\), \(_\)]\) \!\(\*SubscriptBox[\(\[Gamma]\), \(0\)]\)\!\(\*SuperscriptBox[\(T\), \(0\(\\\ \)\)]\)q\!\(\*SuperscriptBox[\()\), \(2\)]\) - (\!\(\*OverscriptBox[\(q\), \(_\)]\) \!\(\*SubscriptBox[\(i\[Gamma]\), \(0\)]\)\!\(\*SubscriptBox[\(\[Gamma]\), \(5\)]\)\!\(\*SuperscriptBox[\(T\), \(0\(\\\ \)\)]\)q\!\(\*SuperscriptBox[\()\), \(2\)]\)"},
