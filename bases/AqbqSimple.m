...
TBAutoDefine["AqbqSimple"]=True;

TBRequiredGroups["AqbqSimple"]={{color,SUNfund,Nc},{flavor,SUNfund,Nf}};

TBVertex["AqbqSimple"]="A\!\(\*OverscriptBox[\(q\), \(_\)]\)q";
...
TBAuthor["AqbqSimple"]="FR Sattler";

TBUsage["AqbqSimple"]={"Indices: 
...
TBIndices["AqbqSimple"]={{p1,mu,a1},{p2,d2,A2,F2},{p3,d3,A3,F3}};

TBMomentumConservation["AqbqSimple"]={p1->-p2-p3};
