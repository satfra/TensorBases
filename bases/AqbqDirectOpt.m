...
(* ::Input::Initialization:: *)
TBAutoDefine["AqbqDirectOpt"]=True;
...
TBIndices["AqbqDirectOpt"]={{p1,mu,a1},{p2,d2,A2,F2},{p3,d3,A3,F3}};

TBMomentumConservation["AqbqDirectOpt"]={p1->-p2-p3};

TBBasis["AqbqDirectOpt"]={

TBT[color,a1,A2,A3] TBdeltaFund[flavor,F2,F3]transProj[p1,mu,rho]( I TBgamma[rho,d2,d3])
(*T^(1)*),

AqbqOptPreFacS0 TBT[color,a1,A2,A3] TBdeltaFund[flavor,F2,F3]transProj[p1,mu,rho]( TBvec[p2-p3,rho])TBdeltaDirac[d2,d3]
(*T^(2)*),

AqbqOptPreFacS0 TBT[color,a1,A2,A3] TBdeltaFund[flavor,F2,F3]transProj[p1,mu,rho]( pdash[p2-p3,d2,md])TBgamma[rho,md,d3]
(*T^(3)*),

AqbqOptPreFacS0 TBT[color,a1,A2,A3] TBdeltaFund[flavor,F2,F3]transProj[p1,mu,rho](-pdash[p2+p3,d2,md]TBgamma[rho,md,d3])
(*T^(4)*),

AqbqOptPreFacS0^2 TBT[color,a1,A2,A3] TBdeltaFund[flavor,F2,F3]transProj[p1,mu,rho]( I pdash[p2+p3,d2,d3]TBvec[p2-p3,rho])
(*T^(5)*),
...
AqbqOptPreFacS0^2 TBT[color,a1,A2,A3] TBdeltaFund[flavor,F2,F3]transProj[p1,mu,rho] I/2 ( pdash[p2,d2,dint1]pdash[p3,dint1,dint2]-pdash[p3,d2,dint1]pdash[p2,dint1,dint2])TBgamma[rho,dint2,d3]
(*T^(7)*),

AqbqOptPreFacS0^3 TBT[color,a1,A2,A3] TBdeltaFund[flavor,F2,F3]transProj[p1,mu,rho] 1/2 ( pdash[p2,d2,md1]pdash[p3,md1,d3]-pdash[p3,d2,md1]pdash[p2,md1,d3])( TBvec[p2-p3,rho])
(*T^(8)*),
